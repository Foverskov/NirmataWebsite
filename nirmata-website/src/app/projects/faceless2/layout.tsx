...
export const metadata: Metadata = {
  ...
  description:
    "A powerful exploration of unhealthy relationships and their impact on mental health. FACELESS by NIRMATA - Electronic Press Kit with band information, release details, and streaming links.",
  keywords:
    "NIRMATA, Faceless, Electronic Press Kit, EPK, Danish rock, modern rock, Copenhagen, Last Mile Records, music press kit",
  ...
  openGraph: {
    title: "FACELESS - NIRMATA Electronic Press Kit",
    description:
      "A powerful exploration of unhealthy relationships and their impact on mental health. Official EPK for FACELESS by NIRMATA.",
