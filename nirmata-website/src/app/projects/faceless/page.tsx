...
export default function FacelessEPK() {
  ...
  return (
    <div className="bg-black text-white">
      ...
      >
        ...
        <div className="relative z-10 container mx-auto px-4 flex flex-col items-center animate-fadeIn">
          ...
          <p className="text-lg md:text-xl mb-8 text-gray-300 max-w-2xl mx-auto text-center animate-fadeIn animation-delay-500 sm:px-4">
            A powerful exploration of unhealthy relationships and their impact
            on mental health.
          </p>
      ...
      <div
        className={`hidden lg:block transition-opacity duration-500 ${showHero ? "opacity-0" : "opacity-100"}`}
      >
        <div className="relative flex min-h-screen">
          ...
          <div className="w-1/2 bg-black/30 backdrop-blur-sm z-10">
            ...
            <div
              id="about"
              className="min-h-screen flex items-center justify-center bg-gradient-to-b from-black/20 to-transparent px-12"
            >
              <div className="w-full max-w-2xl">
                <div className="card-epk p-8">
                  ...
                  <div className="space-y-6 mt-8">
                    ...
                    <p className="text-gray-300 leading-relaxed">
                      ...
                      sections as well as anthemic, powerful choruses, listeners
                      can expect to hear echoes of Karnivool, VOLA, Mastodon,
                      Black Peaks, and Dizzy Mizz Lizzy.
                    </p>
                    <p className="text-gray-300 leading-relaxed">
                      In 2024, the band self-released 3 singles: Empire, Bloom,
                      and Circles - touching on themes of religion, exclusion,
                      and growth.
                    </p>
      ...
      <div
        className={`lg:hidden transition-opacity duration-500 relative ${showHero ? "opacity-0" : "opacity-100"}`}
      >
      ...
      <div
        id="contact"
        className="relative bg-gradient-to-b from-black/20 to-black py-20 backdrop-blur-sm overflow-hidden"
      >
              ...
              <div className="space-y-8">
                ...
                <div className="group p-6 rounded-2xl bg-gradient-to-br from-black/50 to-black/30 hover:from-epk-cyan/20 hover:to-nirmata-primary/20 transition-all duration-500 border border-epk-cyan/30 hover:border-epk-cyan/50 hover:shadow-xl hover:shadow-epk-cyan/20 transform hover:-translate-y-1">
                  ...
                  <div className="space-y-2 pl-16">
                    <p className="text-gray-300 hover:text-epk-cyan transition-colors duration-300 flex items-center gap-2">
                      <span className="text-epk-cyan">✉️</span>{" "}
                      booking@nirmata.com
                    </p>
                    <p className="text-gray-300 hover:text-epk-cyan transition-colors duration-300 flex items-center gap-2">
                ...
                <div className="group p-6 rounded-2xl bg-gradient-to-br from-black/50 to-black/30 hover:from-nirmata-primary/20 hover:to-epk-gold/20 transition-all duration-500 border border-epk-cyan/30 hover:border-nirmata-primary/50 hover:shadow-xl hover:shadow-nirmata-primary/20 transform hover:-translate-y-1">
                  <div className="flex items-center gap-4 mb-4">
                    ...
                    <h5 className="text-xl font-bold text-white group-hover:text-nirmata-primary transition-colors duration-300">
                      Press & Media
                    </h5>
                  </div>
                  <div className="space-y-2 pl-16">
                    <p className="text-gray-300 hover:text-nirmata-primary transition-colors duration-300 flex items-center gap-2">
                      <span className="text-nirmata-primary">✉️</span>{" "}
                      press@nirmata.com
                    </p>
                    <p className="text-gray-300 hover:text-nirmata-primary transition-colors duration-300 flex items-center gap-2">
                      <span className="text-nirmata-primary">🌐</span>{" "}
                      www.nirmata.dk
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-8">
                ...
                <div className="group p-6 rounded-2xl bg-gradient-to-br from-black/50 to-black/30 hover:from-green-900/20 hover:to-emerald-900/20 transition-all duration-500 border border-epk-cyan/30 hover:border-green-500/50 hover:shadow-xl hover:shadow-green-500/20 transform hover:-translate-y-1">
                  ...
                  <div className="grid grid-cols-2 gap-4 pl-4">
                    <a
                      href="#"
                      className="group/link flex items-center gap-3 p-3 rounded-xl bg-black/30 hover:bg-green-500/20 transition-all duration-300 transform hover:scale-105"
                    >
                    ...
                    <a
                      href="#"
                      className="group/link flex items-center gap-3 p-3 rounded-xl bg-black/30 hover:bg-red-500/20 transition-all duration-300 transform hover:scale-105"
                    >
                      <div className="w-8 h-8 bg-red-500 rounded-lg flex items-center justify-center">
                        <span className="text-white text-sm">♪</span>
                      </div>
                      <span className="text-gray-300 group-hover/link:text-red-300 font-medium">
                        Apple Music
                      </span>
                    </a>
                    <a
                      href="#"
                      className="group/link flex items-center gap-3 p-3 rounded-xl bg-black/30 hover:bg-orange-500/20 transition-all duration-300 transform hover:scale-105"
                    >
                      <div className="w-8 h-8 bg-orange-500 rounded-lg flex items-center justify-center">
                        <span className="text-white text-sm">♪</span>
                      </div>
                      <span className="text-gray-300 group-hover/link:text-orange-300 font-medium">
                        SoundCloud
                      </span>
                    </a>
                    <a
                      href="#"
                      className="group/link flex items-center gap-3 p-3 rounded-xl bg-black/30 hover:bg-purple-500/20 transition-all duration-300 transform hover:scale-105"
                    >
                      <div className="w-8 h-8 bg-purple-500 rounded-lg flex items-center justify-center">
                        <span className="text-white text-sm">♪</span>
                      </div>
                      <span className="text-gray-300 group-hover/link:text-purple-300 font-medium">
                        Bandcamp
                      </span>
                    </a>
                  </div>
                ...
                <div className="group p-6 rounded-2xl bg-gradient-to-br from-black/50 to-black/30 hover:from-blue-900/20 hover:to-indigo-900/20 transition-all duration-500 border border-epk-cyan/30 hover:border-blue-500/50 hover:shadow-xl hover:shadow-blue-500/20 transform hover:-translate-y-1">
                  ...
                  <div className="grid grid-cols-2 gap-4 pl-4">
                    <a
                      href="#"
                      className="group/link flex items-center gap-3 p-3 rounded-xl bg-black/30 hover:bg-blue-500/20 transition-all duration-300 transform hover:scale-105"
                    >
                    ...
                    <a
                      href="#"
                      className="group/link flex items-center gap-3 p-3 rounded-xl bg-black/30 hover:bg-pink-500/20 transition-all duration-300 transform hover:scale-105"
                    >
                      <div className="w-8 h-8 bg-gradient-to-r from-pink-500 to-purple-500 rounded-lg flex items-center justify-center">
                        <span className="text-white text-sm">📷</span>
                      </div>
                      <span className="text-gray-300 group-hover/link:text-pink-300 font-medium">
                        Instagram
                      </span>
                    </a>
                    <a
                      href="#"
                      className="group/link flex items-center gap-3 p-3 rounded-xl bg-black/30 hover:bg-sky-500/20 transition-all duration-300 transform hover:scale-105"
                    >
                      <div className="w-8 h-8 bg-sky-500 rounded-lg flex items-center justify-center">
                        <span className="text-white text-sm">X</span>
                      </div>
                      <span className="text-gray-300 group-hover/link:text-sky-300 font-medium">
                        Twitter/X
                      </span>
                    </a>
                    <a
                      href="#"
                      className="group/link flex items-center gap-3 p-3 rounded-xl bg-black/30 hover:bg-red-600/20 transition-all duration-300 transform hover:scale-105"
                    >
